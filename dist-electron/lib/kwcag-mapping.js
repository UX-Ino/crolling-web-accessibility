...
exports.KWCAG_MAPPING = void 0;
exports.getKWCAGGuideline = getKWCAGGuideline;
exports.formatKWCAGGuideline = formatKWCAGGuideline;
exports.getKoreanDescription = getKoreanDescription;
exports.getKoreanHelp = getKoreanHelp;
exports.getImpactInfo = getImpactInfo;
exports.getCertificationRequiredRules = getCertificationRequiredRules;
exports.getAutomaticRules = getAutomaticRules;
exports.getManualRules = getManualRules;
// Axe-core Rule ID를 KWCAG 2.2 검사 항목으로 변환하는 매핑 테이블
exports.KWCAG_MAPPING = {
    // =======================================================
 ...
 */
function getKWCAGGuideline(ruleId) {
    return exports.KWCAG_MAPPING[ruleId] || {
        seq: 0,
        code: '기타',
        name: 'WCAG 기준',
        isAutomatic: true,
 ...
 * KWCAG 지침명 포맷 ([코드] 이름)
 */
function formatKWCAGGuideline(ruleId) {
 ...
 * 한국어 설명 가져오기
 */
function getKoreanDescription(ruleId, defaultDescription) {
    const guideline = exports.KWCAG_MAPPING[ruleId];
    return guideline?.koreanDescription || defaultDescription;
}
/**
 * 한국어 해결방안 가져오기
 */
function getKoreanHelp(ruleId, defaultHelp) {
    const guideline = exports.KWCAG_MAPPING[ruleId];
 ...
 * 인증 필수 항목만 필터링
 */
function getCertificationRequiredRules() {
    return Object.entries(exports.KWCAG_MAPPING)
